...
def cure_tsr_intermediate_tasksets(
    inter_dir,
    train_ways,
    train_samples,
    test_ways,
...
def get_cure_tsr_inter_tasksets(
    #name,
    inter_dir,
    train_ways=5,
    train_samples=10,
    ...
    **kwargs,
    ...
    datasets, transforms = cure_tsr_intermediate_tasksets(inter_dir, train_ways=train_ways,
