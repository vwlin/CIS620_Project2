"""
    [1] https://github.com/olivesgatech/CURE-TSR/blob/master/utils.py 
"""
import random
import os
import torch
...
def make_dataset (traindir):
    ...
    for fname in sorted(os.listdir(traindir)):
        target = int(fname[3:5]) - 1 # since we have image filename as "sequenceType_signType_challengeType_challengeLevel_Index.bmp" where signType is label and given by 3:5 items of filename
