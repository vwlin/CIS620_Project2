...
import os, sys
sys.path.append('/data3/ksridhar/cis620_project/gradual_domain_adaptation')
import shutil
...
def save_data(target_size=(32, 32)):
    for subdir, dirs, files in os.walk("/data3/ksridhar/cis620_project/gradual_domain_adaptation/CURE_TSR/Real_Train"):
        if subdir != dirs:
